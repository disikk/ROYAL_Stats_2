...
class OverallStats(BaseModel):
    ...
    # Средний результат в фишках до финального стола
    # (сумма стартовых стеков на финальных столах минус
    #  количество турниров без финалки * 1000) /
    #  общее количество турниров
    pre_ft_chipev: float = 0.0
