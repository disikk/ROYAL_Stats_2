...
class AppFacade:
    ...
    def __init__(
        ...
        self._tournament_repo = TournamentRepository(db_manager=db_manager)
        self._session_repo = SessionRepository(db_manager=db_manager)
    ...
    def create_stats_grid_viewmodel(
        ...
        if buyin_filter is not None:
            ...
            ft_hand_repo = FinalTableHandRepository(db_manager=self.db_manager)
